...
{
    class GreatArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, ProjectileID.InfernoFriendlyBlast, (int)(projectile.damage * 0.5), 0f, projectile.owner, 0f, 0f);
			}
			...
			if (Main.rand.Next(5) == 0) // only spawn 20% of the time
			{
				...
				// Spawn the dust
				//Dust.NewDust(projectile.position, projectile.width, projectile.height, choice, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 150, default(Color), 0.7f);
			}
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
			...
			Dust.NewDust(projectile.position, projectile.width, projectile.height, 70, projectile.velocity.X * 0.25f, projectile.velocity.Y * 0.25f, 150, Color.Red, 1f);
